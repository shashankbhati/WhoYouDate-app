...
export function seedEntries(): Entry[] {
  ...
  for (let i = 0; i < 600; i++) {
    ...
    const secondDateProb = mood >= 4 ? 0.65 : mood === 3 ? 0.4 : 0.15;
    const secondDate: Entry["secondDate"] =
      Math.random() < secondDateProb
        ? mood === 5 && Math.random() < 0.3
          ? "together"
          : "yes"
        : "no";
  ...
  for (let i = 0; i < 12; i++) {
    out.push({
      ...
      amountCents: 42000 + Math.floor(Math.random() * 18000),
      currency: "EUR",
      partnerName: "Sven",
      mood: 5,
      meetVia: "hinge",
  ...
  for (let i = 0; i < 10; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: "food_date",
      amountCents: 13000 + Math.floor(Math.random() * 4000),
      currency: "EUR",
      partnerName: "Sabrina",
      mood: 5,
      meetVia: "bumble",
      secondDate: "yes",
      city: "Munich",
      entryDate: new Date(now - i * 86400000).toISOString(),
  ...
  for (let i = 0; i < 8; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: i % 3 === 0 ? "trip" : "food_date",
      amountCents: 11000 + Math.floor(Math.random() * 3000),
      currency: "EUR",
      partnerName: "Klaus",
      mood: (Math.floor(Math.random() * 2) + 3) as Entry["mood"],
      meetVia: "tinder",
      secondDate: "no",
      city: "Munich",
      entryDate: new Date(now - i * 86400000 * 3).toISOString(),
  ...
  for (let i = 0; i < 9; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: i % 2 === 0 ? "food_date" : "gift",
      amountCents: 12500 + Math.floor(Math.random() * 2500),
      currency: "EUR",
      partnerName: "Sophie",
      mood: (Math.floor(Math.random() * 2) + 4) as Entry["mood"],
      meetVia: "hinge",
      secondDate: "yes",
      city: "Frankfurt",
      entryDate: new Date(now - i * 86400000 * 2).toISOString(),
  ...
  for (let i = 0; i < 8; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: "coffee",
      amountCents: 1100 + Math.floor(Math.random() * 400),
      currency: "EUR",
      partnerName: "Emma",
      mood: 5,
      meetVia: "bumble",
  ...
  for (let i = 0; i < 10; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: rand(["food_date", "movie", "coffee"]),
      amountCents: 9500 + Math.floor(Math.random() * 2000),
      currency: "EUR",
      partnerName: "Laura",
      mood: (Math.floor(Math.random() * 2) + 3) as Entry["mood"],
      meetVia: "tinder",
      secondDate: Math.random() > 0.5 ? "yes" : "no",
      city: "Berlin",
      entryDate: new Date(now - i * 86400000 * 2).toISOString(),
      createdAt: new Date(now - i * 86400000 * 2).toISOString(),
    });
  ...
  for (let i = 0; i < 7; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: "food_date",
      amountCents: 10500 + Math.floor(Math.random() * 2500),
      currency: "EUR",
      partnerName: "Robert",
      mood: 4,
      meetVia: "friends",
      secondDate: "yes",
      city: "Cologne",
      entryDate: new Date(now - i * 86400000 * 4).toISOString(),
      createdAt: new Date(now - i * 86400000 * 4).toISOString(),
    });
  }
  ...
  for (let i = 0; i < 8; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: i % 2 === 0 ? "movie" : "coffee",
      amountCents: 8000 + Math.floor(Math.random() * 2000),
      currency: "EUR",
      partnerName: "Jan",
      mood: 4,
      meetVia: "bumble",
  ...
  for (let i = 0; i < 6; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: "trip",
      amountCents: 9000 + Math.floor(Math.random() * 4000),
      currency: "EUR",
      partnerName: "Jens",
      mood: 3,
      meetVia: "other_app",
      secondDate: "no",
      city: "Munich",
      entryDate: new Date(now - i * 86400000 * 5).toISOString(),
      createdAt: new Date(now - i * 86400000 * 5).toISOString(),
    });
  }
  // --- Maximilian trending ---
  for (let i = 0; i < 8; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: i % 3 === 0 ? "gift" : "food_date",
      amountCents: 10000 + Math.floor(Math.random() * 3000),
      currency: "EUR",
      partnerName: "Maximilian",
      mood: (Math.floor(Math.random() * 2) + 3) as Entry["mood"],
      meetVia: "hinge",
      secondDate: Math.random() > 0.4 ? "yes" : "no",
      city: rand(["Berlin", "Munich"]),
      entryDate: new Date(now - i * 86400000 * 2).toISOString(),
      createdAt: new Date(now - i * 86400000 * 2).toISOString(),
    });
  }
  ...
  for (let i = 0; i < 52; i++) {
    ...
    out.push({
      ...
      partnerName: "Sophie",
      mood,
      meetVia: weightedRand([...MEET_VIA], [10, 45, 15, 12, 8, 5, 5]),
      secondDate: (Math.random() < sd
        ? mood === 5 && Math.random() < 0.35
          ? "together"
          : "yes"
        : "no") as Entry["secondDate"],
      city,
      entryDate: new Date(now - daysAgo * 86400000).toISOString(),
      createdAt: new Date(now - daysAgo * 86400000).toISOString(),
    });
  ...
  for (let i = 0; i < 52; i++) {
    ...
    out.push({
      ...
      partnerName: "Lina",
      mood,
      meetVia: weightedRand([...MEET_VIA], [40, 20, 20, 8, 5, 3, 4]),
      secondDate: (Math.random() < sd
        ? mood === 5 && Math.random() < 0.25
          ? "together"
          : "yes"
        : "no") as Entry["secondDate"],
      city,
  ...
  for (let i = 0; i < 52; i++) {
    ...
    out.push({
      ...
      partnerName: "Thomas",
      mood,
      meetVia: weightedRand([...MEET_VIA], [15, 20, 25, 15, 20, 3, 2]),
      secondDate: (Math.random() < sd
        ? mood === 5 && Math.random() < 0.3
          ? "together"
          : "yes"
  ...
  for (let i = 0; i < 52; i++) {
    ...
    out.push({
      ...
      partnerName: "Anna",
      mood,
      meetVia: weightedRand([...MEET_VIA], [15, 35, 15, 20, 12, 2, 1]),
      secondDate: (Math.random() < sd
        ? mood === 5 && Math.random() < 0.4
          ? "together"
          : "yes"
        : "no") as Entry["secondDate"],
      city,
  ...
  for (let i = 0; i < 52; i++) {
    ...
    out.push({
      ...
      partnerName: "Johanna",
      mood,
      meetVia: weightedRand([...MEET_VIA], [10, 50, 15, 10, 10, 3, 2]),
      secondDate: (Math.random() < sd
        ? mood === 5 && Math.random() < 0.45
          ? "together"
          : "yes"
        : "no") as Entry["secondDate"],
      city,
...
export function seedEntriesDresden(): Entry[] {
  ...
  for (let i = 0; i < 80; i++) {
    ...
    out.push({
      ...
      partnerName,
      mood,
      meetVia: MEET_VIA_D[Math.floor(Math.random() * MEET_VIA_D.length)],
      secondDate: (Math.random() < sd ? "yes" : "no") as Entry["secondDate"],
      city: "Dresden",
      entryDate: new Date(now - daysAgo * 86400000).toISOString(),
      createdAt: new Date(now - daysAgo * 86400000).toISOString(),
    });
  ...
  for (let i = 0; i < 12; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: i % 3 === 0 ? "trip" : "food_date",
      amountCents: 38000 + Math.floor(Math.random() * 14000),
      currency: "EUR",
      partnerName: "Franziska",
      mood: 5,
      meetVia: "hinge",
      secondDate: "together",
      city: "Dresden",
  ...
  for (let i = 0; i < 10; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: i % 2 === 0 ? "trip" : "gift",
      amountCents: 29000 + Math.floor(Math.random() * 12000),
      currency: "EUR",
      partnerName: "Hannes",
      mood: 4,
      meetVia: "bumble",
  ...
  for (let i = 0; i < 9; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: i % 2 === 0 ? "coffee" : "movie",
      amountCents: 1200 + Math.floor(Math.random() * 600),
      currency: "EUR",
      partnerName: "Klara",
      mood: (Math.floor(Math.random() * 2) + 4) as Entry["mood"],
      meetVia: "tinder",
  ...
  for (let i = 0; i < 8; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: "food_date",
      amountCents: 9500 + Math.floor(Math.random() * 3000),
      currency: "EUR",
      partnerName: "Moritz",
      mood: 3,
      meetVia: "friends",
...
export function seedEntriesTabeaShashank(): Entry[] {
  ...
  for (let i = 0; i < 18; i++) {
    ...
    const mood = (
      i < 12 ? weightedRand([3, 4, 5], [10, 40, 50]) : weightedRand([2, 3, 4], [20, 45, 35])
    ) as Entry["mood"];
  ...
  for (let i = 0; i < 18; i++) {
    ...
    const mood = (
      i < 10
        ? weightedRand([2, 3, 4, 5], [10, 30, 35, 25])
        : weightedRand([1, 2, 3, 4], [15, 30, 35, 20])
    ) as Entry["mood"];
    const sd: Entry["secondDate"] =
      mood >= 4 ? "yes" : mood === 3 && Math.random() > 0.5 ? "yes" : "no";
    ...
    out.push({
      ...
      amountCents: amount,
      currency: "INR",
      partnerName: "Shashank",
      mood,
      meetVia: i % 2 === 0 ? "tinder" : "hinge",
      secondDate: sd,
      city,
      entryDate: new Date(now - daysAgo * 86400000).toISOString(),
      createdAt: new Date(now - daysAgo * 86400000).toISOString(),
...
export function seedEntriesIndia(): Entry[] {
  ...
  for (let i = 0; i < 500; i++) {
    ...
    out.push({
      ...
      amountCents: amount,
      currency: "INR",
      partnerName: rand(IN_NAMES),
      mood,
      meetVia: rand(MEET_VIA),
      secondDate,
      city,
      entryDate: new Date(now - daysAgo * 86400000).toISOString(),
      createdAt: new Date(now - daysAgo * 86400000).toISOString(),
  ...
  for (let i = 0; i < 14; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: i % 3 === 0 ? "trip" : "food_date",
      amountCents: 160000 + Math.floor(Math.random() * 60000),
      currency: "INR",
      partnerName: "Priya",
      mood: 5,
      meetVia: "hinge",
  ...
  for (let i = 0; i < 12; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: i % 4 === 0 ? "trip" : "food_date",
      amountCents: 120000 + Math.floor(Math.random() * 50000),
      currency: "INR",
      partnerName: "Rahul",
      mood: (Math.floor(Math.random() * 2) + 4) as Entry["mood"],
      meetVia: weightedRand([...MEET_VIA], [20, 30, 25, 10, 5, 5, 5]),
      secondDate: Math.random() > 0.4 ? "yes" : "no",
      city: "Delhi",
      entryDate: new Date(now - i * 86400000 * 3).toISOString(),
      createdAt: new Date(now - i * 86400000 * 3).toISOString(),
  ...
  for (let i = 0; i < 10; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: i % 2 === 0 ? "gift" : "food_date",
      amountCents: 90000 + Math.floor(Math.random() * 40000),
      currency: "INR",
      partnerName: "Anjali",
      mood: (Math.floor(Math.random() * 2) + 3) as Entry["mood"],
      meetVia: "bumble",
  ...
  for (let i = 0; i < 8; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: rand(["food_date", "movie", "coffee"]),
      amountCents: 70000 + Math.floor(Math.random() * 30000),
      currency: "INR",
      partnerName: "Neha",
      mood: (Math.floor(Math.random() * 2) + 3) as Entry["mood"],
      meetVia: "tinder",
...
export function seedEntriesUS(): Entry[] {
  ...
  for (let i = 0; i < 400; i++) {
    ...
    const mood = weightedRand([1, 2, 3, 4, 5], MOOD_W) as Entry["mood"];
    const secondDateProb = mood >= 4 ? 0.63 : mood === 3 ? 0.4 : 0.15;
    const secondDate: Entry["secondDate"] =
      Math.random() < secondDateProb
        ? mood === 5 && Math.random() < 0.3
          ? "together"
  ...
  for (let i = 0; i < 12; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: i % 3 === 0 ? "trip" : "food_date",
      amountCents: 14000 + Math.floor(Math.random() * 6000),
      currency: "USD",
      partnerName: "Ashley",
      mood: 5,
      meetVia: "hinge",
  ...
  for (let i = 0; i < 10; i++) {
    out.push({
      ...
      userId: "seed_" + uid(),
      activity: i % 2 === 0 ? "food_date" : "gift",
      amountCents: 9000 + Math.floor(Math.random() * 3000),
      currency: "USD",
      partnerName: "Emma",
      mood: (Math.floor(Math.random() * 2) + 4) as Entry["mood"],
      meetVia: "tinder",
  ...
  for (let i = 0; i < 8; i++) {
    out.push({
      id: uid(),
      userId: "seed_" + uid(),
      activity: rand(["food_date", "movie"]),
      amountCents: 6500 + Math.floor(Math.random() * 2000),
      currency: "USD",
      partnerName: "Jordan",
      mood: 4,
      meetVia: "hinge",
...
export function seedPosts(): Post[] {
  const now = Date.now();
  const SPREAD = 3.9; // spread seeded posts/comments across ~35 days, not a bursty 9
  const t = (d: number) => new Date(now - d * SPREAD * 86400000).toISOString();
  ...
  const c = (content: string, daysAgo = 2) => ({
    id: uid(),
    author: rand(COMMENT_AUTHORS),
    content,
    upvotes: Math.floor(Math.random() * 16) + 1,
    downvotes: 0,
    createdAt: t(daysAgo),
  });
  ...
  return [
    {
      id: uid(),
      author: "berlindater92",
      type: "experience",
      tags: ["Experience", "Berlin"],
      content:
        "alter ich hab gerade €87 für pasta ausgegeben und sie hat danach 2h lang nicht mehr geantwortet. nicht mal ein danke text. ich stehe so dumm da rn 💀",
      upvotes: 34,
      downvotes: 2,
      createdAt: t(2),
      comments: [
        ...
        c(
          "das ghosting danach macht es noch viel schlimmer als wenn sie direkt nein gesagt hätte",
          1,
        ),
      ],
    },
    {
      id: uid(),
      author: "kaffeemensch_bln",
      type: "advice",
      tags: ["Advice", "Coffee"],
      content:
        "hot take: kaffee dates sind die beste erfindung der modernen dating szene. €9, kein awkward schweigen wenn das essen kommt, und wenn es shit ist kannst du nach 30min weg. warum macht das nicht jeder so",
      upvotes: 47,
      downvotes: 1,
      createdAt: t(3),
      comments: [
        ...
        c(
          "gegenargument: wenn es gut läuft willst du gar nicht gehen. letzten monat 4h in einem café versessen",
          2,
        ),
        c(
          "ja aber dann kannst du trotzdem zum essen verlängern. keine verpflichtung am anfang. das ist der punkt",
          2,
        ),
        c(
          'mein letztes date fand kaffee "nicht richtig genug" als erstes date... andere zeiten 💀',
          1,
        ),
      ],
    },
    {
      id: uid(),
      author: "hingemüde2024",
      type: "experience",
      tags: ["Experience", "Hinge"],
      content:
        "diesen monat 4 hinge dates gemacht. 3 davon haben einfach aufgehört zu schreiben danach, ohne grund, ohne ankündigung. hab zusammen ca €140 ausgegeben. ich glaub ich brauch eine pause",
      upvotes: 29,
      downvotes: 1,
      createdAt: t(1),
      comments: [
        ...
        c(
          "bumble mal versuchen? da müssen frauen anfangen, irgendwie seriösere leute meiner erfahrung nach",
          1,
        ),
    ...
    {
      id: uid(),
      author: "wer_zahlt_wtf",
      type: "question",
      tags: ["Question"],
      content:
        'echte frage wer zahlt beim ersten date? ich bin ein typ und ich zahle immer aber neulich hat mein date fast drüber gestritten, meinte es sei "weird und old fashioned"... bin ich der einzige der das noch so macht',
      upvotes: 43,
      downvotes: 5,
      createdAt: t(5),
      comments: [
        ...
        c(
          "ich (w) zahle immer selbst für das erste date. will niemandem was schulden bevor ich die person kenne",
          2,
        ),
      ],
    },
    {
      id: uid(),
      author: "impulsiv_aber_froh",
      type: "experience",
      tags: ["Experience", "Trip"],
      content:
        "hab spontan ein wochenende nach amsterdam gebucht mit meinem date, 3. treffen, €280 zusammen für hotel + zug. war das dumm? ja. war es das wert? auch ja. update folgt wenn ich zurück bin",
      upvotes: 58,
      downvotes: 1,
      createdAt: t(4),
      comments: [
        ...
        c(
          "3. date amsterdam ist entweder die beste oder schlechteste entscheidung, kein mittelweg",
          3,
        ),
    ...
    {
      id: uid(),
      author: "stadtmensch_BE",
      type: "observation",
      tags: ["Observation", "Berlin"],
      content:
        "berliner dating preise sind in 2 jahren so krass gestiegen. 2022 waren restaurants in mitte noch okay, jetzt zahlst du €25 für pasta die nix besonderes ist. ich date inzwischen nur noch in friedrichshain oder neukölln",
      upvotes: 33,
      downvotes: 2,
      createdAt: t(7),
      comments: [
        c(
          "neukölln is die antwort. bessere vibes, bessere preise, irgendwie auch bessere gespräche",
          7,
        ),
        c("prenzlauer berg auch nicht mehr billig lol. kreuzberg geht noch so", 5),
        c(
          "das liegt auch daran dass überall touristenrestaurants aufgemacht haben in mitte seitdem",
          3,
        ),
      ],
    },
    {
      ...
      tags: ["Experience"],
      content:
        "UPDATE: das kaffee date von montag... heute ist unser 3. date und sie wollte nach 2h gar nicht aufhören. ich glaube daran leute 😭",
      upvotes: 70,
      downvotes: 1,
      createdAt: t(0),
      comments: [
    ...
    {
      id: uid(),
      author: "kino_lover_bln",
      type: "advice",
      tags: ["Advice", "Movie"],
      content:
        "kino dates sind so underrated digga. €22 zusammen, ihr müsst nicht die ganze zeit reden, danach habt ihr direkt ein thema. und wenn der film scheiße war habt ihr was gemeinsam worüber ihr lachen könnt",
      upvotes: 20,
      downvotes: 2,
      createdAt: t(6),
      comments: [
    ...
    {
      id: uid(),
      author: "münchen_armut",
      type: "observation",
      tags: ["Observation"],
      content:
        "münchen vs berlin dating mal ehrlich verglichen: gleicher restauranttyp, münchen locker 30% teurer. ich versteh münchen leute nicht wie ihr das schafft. respekt aber auch bitte helft mir",
      upvotes: 27,
      downvotes: 1,
      createdAt: t(8),
      comments: [
        ...
        c(
          "ich bin aus münchen nach berlin gezogen teilweise wegen dating kosten, nicht mal im spaß",
          3,
        ),
      ],
    },
    {
      id: uid(),
      author: "geschenke_reue",
      type: "experience",
      tags: ["Experience", "Gift"],
      content:
        "hab in 3 monaten €180 in geschenken für sie ausgegeben. sie hat dann mit jemand anderem angefangen. ich sitz hier und lerne gerade eine lektion die ich mir selbst hätte sparen können 🤡",
      upvotes: 49,
      downvotes: 1,
      createdAt: t(9),
      comments: [
    ...
    },
    {
      ...
      tags: ["Observation"],
      content:
        "informelle statistik aus eigenen dates: hinge dates geben am meisten aus (~€65 avg), tinder am wenigsten (~€28), bumble irgendwo dazwischen. macht für mich sinn – die app bestimmt die erwartungen. stimmt das bei euch auch so?",
      upvotes: 39,
      downvotes: 1,
      createdAt: t(3),
      comments: [
        ...
        c(
          "irl begegnungen > alle apps bei mir. die leute sind echter wenn man sich zufällig trifft",
          2,
        ),
    ...
    {
      id: uid(),
      author: "delhidater_cp",
      type: "experience",
      tags: ["Experience"],
      content:
        "first date at connaught place, started with coffee ₹480, she suggested dinner after. total ₹2200. best ₹2200 i ever spent ngl, we're meeting again saturday 🙏",
      upvotes: 18,
      downvotes: 1,
      createdAt: t(2),
      comments: [
    ...
    },
    {
      ...
      tags: ["Observation"],
      content:
        "NYC dinner date is $140+ now if you're going anywhere decent. we're all just out here bleeding money to find love lmao. anyway how are we all holding up",
      upvotes: 32,
      downvotes: 1,
      createdAt: t(5),
      comments: [
    ...
    {
      id: uid(),
      author: "erstes_date_win",
      type: "experience",
      tags: ["Experience", "Coffee"],
      content:
        'erstes date heute: kaffee, 45min. dann spaziergehen, 2h. dann spontan essen, €34 zusammen. dann noch ein bier. gesamt 5h, sie hat sich mit "bis bald" verabschiedet. ich glaub das ist ein gutes zeichen oder??',
      upvotes: 53,
      downvotes: 1,
      createdAt: t(1),
      comments: [
